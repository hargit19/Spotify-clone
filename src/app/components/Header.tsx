...
<div className='w-15 h-10 text-sm text-[#A7A7A7] font-bold flex items-center'>
  <span>Sign Up</span>
</div>
<div className='w-28 h-12 rounded-full bg-white text-sm text-black font-bold border-none flex items-center justify-center'>
